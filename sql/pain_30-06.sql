...
--
-- Servidor: localhost
-- Tiempo de generación: 30-06-2016 a las 16:31:38
...
INSERT INTO `Pain_report` (`id_patient`, `level`, `created`) VALUES
(2, 5, '2016-06-30 19:34:18'),
(2, 6, '2016-06-30 19:34:18'),
(2, 7, '2016-06-30 19:34:30'),
(2, 8, '2016-06-30 19:34:30');
...
INSERT INTO `Patient` (`id_user`, `id_doctor`) VALUES
(2, 3),
(4, 3);
...
(3, 'David', 'Cordova', 'david@correo.com', '1f0160076c9f42a157f0a8f0dcc68e02ff69045b', b'1', 0, 'm', 'profile.png', 0),
...
--
ALTER TABLE `Patient`
 ADD KEY `FK_Patient_User` (`id_user`), ADD KEY `id_doctor` (`id_doctor`);
