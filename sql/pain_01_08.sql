...
--
-- Servidor: localhost
-- Tiempo de generación: 01-08-2016 a las 16:17:47
...
CREATE TABLE IF NOT EXISTS `Application` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Application_Dose` (`id_dose`)
...
INSERT INTO `Application` (`id`, `application`, `suppose`, `id_dose`, `id_patch`, `id_orientation`) VALUES
(1, '2016-07-26 16:17:29', '2016-07-29 16:17:29', 3, 0, 0),
(2, '2016-07-26 17:24:44', '2016-07-29 17:24:44', 2, 0, 0),
(3, '2016-07-26 19:30:20', '2016-07-29 19:30:20', 9, 0, 0),
(4, '2016-07-29 14:58:23', '2016-08-01 14:58:23', 3, 0, 1),
(5, '2016-07-31 20:30:40', '2016-08-03 20:30:40', 15, 0, 0),
(6, '2016-08-01 01:33:29', '2016-08-04 01:33:29', 17, 0, 0),
(7, '2016-08-01 01:38:41', '2016-08-04 01:38:41', 3, 0, 1),
(8, '2016-08-01 01:50:31', '2016-08-04 01:50:31', 1, 0, 0),
(9, '2016-08-01 02:34:03', '2016-08-04 02:34:03', 18, 0, 0),
(10, '2016-08-01 13:31:24', '2016-08-04 13:31:24', 15, 0, 1);
...
INSERT INTO `Doctor` (`id_user`, `id_specialization`, `profile`, `id_country`, `alert`, `day_patch`) VALUES
(3, 9, '', 1, 0, 0),
(5, 19, '', 1, 0, 0),
(16, 21, '', 4, 0, 0);
...
(1, 1, 1, '2016-07-26 00:18:52', 3, NULL, 0),
(2, 2, 2, '2016-07-26 14:32:36', 3, NULL, 0),
(3, 2, 3, '2016-07-26 15:48:44', 3, NULL, 0),
(7, 1, 7, '2016-07-26 18:10:11', 3, NULL, 0),
(8, 1, 8, '2016-07-26 18:11:03', 3, NULL, 0),
(9, 2, 9, '2016-07-26 19:22:05', 3, NULL, 0),
(10, 1, 10, '2016-07-29 14:50:07', 3, NULL, 0),
(11, 1, 11, '2016-07-29 14:50:08', 3, NULL, 0),
(12, 1, 12, '2016-07-29 14:50:09', 3, NULL, 0),
(13, 1, 13, '2016-07-29 14:50:10', 3, NULL, 0),
(14, 1, 14, '2016-07-29 23:09:53', 3, NULL, 0),
(15, 1, 15, '2016-07-30 22:11:44', 3, NULL, 0),
(16, 1, 16, '2016-08-01 01:26:13', 3, NULL, 0),
(17, 1, 17, '2016-08-01 01:27:15', 3, NULL, 0),
(18, 1, 18, '2016-08-01 01:46:11', 3, NULL, 0),
(19, 1, 19, '2016-08-01 12:45:27', 3, NULL, 0),
(20, 2, 20, '2016-08-01 13:23:09', 3, NULL, 0),
(21, 1, 21, '2016-08-01 13:56:03', 3, NULL, 0),
(22, 9, 22, '2016-08-01 14:25:38', 7, NULL, 0),
(23, 1, 23, '2016-08-01 15:52:36', 3, NULL, 0);
...
(1, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 1, '0000-00-00 00:00:00'),
(2, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 1, '0000-00-00 00:00:00'),
(3, 14, 0, '"tu medico te solicita pedir una cita"', NULL, 9, 3, '0000-00-00 00:00:00'),
(4, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 4, '0000-00-00 00:00:00'),
(5, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(6, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(7, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(8, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(9, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(10, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 4, '0000-00-00 00:00:00'),
(11, 14, 0, '"tu medico te solicita pedir una cita"', NULL, 9, 3, '0000-00-00 00:00:00'),
(12, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(13, 6, 1, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '0000-00-00 00:00:00'),
(14, 14, 0, '"tu medico te solicita pedir una cita"', NULL, 9, 3, '0000-00-00 00:00:00'),
(15, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 4, '0000-00-00 00:00:00'),
(16, 32, 0, '"tu medico te solicita pedir una cita"', NULL, 17, 6, '0000-00-00 00:00:00'),
(17, 7, 1, '"tu medico te solicita pedir una cita"', NULL, 3, 7, '0000-00-00 00:00:00'),
(18, 30, 1, '"tu medico te solicita pedir una cita"', NULL, 15, 10, '0000-00-00 00:00:00'),
(19, 30, 0, '"tu medico te solicita pedir una cita"', NULL, 15, 10, '0000-00-00 00:00:00'),
(20, 33, 0, '"tu medico te solicita pedir una cita"', NULL, 18, 9, '2016-08-01 15:57:54'),
(21, 6, 0, '"tu medico te solicita pedir una cita"', NULL, 2, 2, '2016-08-01 15:58:03'),
(22, 7, 0, '"tu medico te solicita pedir una cita"', NULL, 3, 7, '2016-08-01 15:58:04'),
(23, 14, 0, '"tu medico te solicita pedir una cita"', NULL, 9, 3, '2016-08-01 15:58:05'),
(24, 30, 0, '"tu medico te solicita pedir una cita"', NULL, 15, 10, '2016-08-01 15:58:06'),
(25, 32, 0, '"tu medico te solicita pedir una cita"', NULL, 17, 6, '2016-08-01 15:58:06');
...
(7, 10, '2016-07-26 16:18:12', 0, 1),
(6, 10, '2016-07-26 16:20:41', 0, 1),
(14, 10, '2016-07-26 19:29:49', 0, 1),
(4, 7, '2016-07-26 00:00:00', 0, 7),
(4, 3, '2016-07-25 00:00:00', 0, 6),
(4, 6, '2016-07-24 00:00:00', 0, 5),
(4, 2, '2016-07-20 00:00:00', 0, 1),
(4, 7, '2016-07-23 00:00:00', 0, 4),
(4, 7, '2016-07-22 00:00:00', 0, 3),
(4, 3, '2016-07-21 00:00:00', 0, 2),
(14, 6, '2016-07-27 00:00:00', 0, 2),
(14, 8, '2016-07-28 00:00:00', 0, 3),
(6, 8, '2016-07-27 00:00:00', 0, 2),
(6, 9, '2016-07-28 00:00:00', 0, 3),
(7, 8, '2016-07-27 00:00:00', 0, 2),
(7, 3, '2016-07-28 00:00:00', 0, 3),
(7, 8, '2016-07-29 14:58:11', 0, 2),
(6, 8, '2016-07-30 16:27:56', 0, 4),
(30, 5, '2016-07-31 02:09:32', 0, 1),
(32, 8, '2016-08-01 01:33:39', 0, 1),
(32, 7, '2016-08-01 01:34:38', 0, 1),
(32, 7, '2016-08-01 01:35:27', 0, 1),
(7, 5, '2016-08-01 01:38:22', 0, 5),
(7, 0, '2016-08-01 01:38:30', 0, 5),
(7, 6, '2016-08-01 01:38:49', 0, 5),
(4, 8, '2016-08-01 01:52:08', 0, 6),
(33, 5, '2016-08-01 02:33:53', 0, 1),
(33, 4, '2016-08-01 02:35:42', 0, 1),
(33, 4, '2016-08-01 02:50:33', 0, 1),
(6, 4, '2016-08-01 05:00:45', 0, 5),
(30, 10, '2016-08-01 13:30:58', 0, 2);
...
CREATE TABLE IF NOT EXISTS `Patient` (
  ...
  KEY `FK_Patient_Country` (`id_country`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `Patient` (`id_user`, `id_doctor`, `id_institution`, `id_country`, `id_diagnosis`) VALUES
(4, 3, 145, 1, 1),
(6, 5, 108, 1, 2),
(7, 5, 108, 1, 1),
(12, 3, 117, 1, 2),
...
(1, '0001', 'Transtec', 'Transtec 35 µg/h\r\n', 3, b'1', '2016-06-28 15:56:33', 1),
(2, '0002', 'Transtec', 'Transtec 52.5 µg/h\r\n', 3, b'1', '2016-06-29 19:27:14', 1),
(3, '0003', 'Transtec', 'Transtec 70 µg/h', 3, b'1', '2016-06-29 19:27:32', 1),
(4, '0004', 'Transtec', 'Transtec 35 µg/h', 3, b'1', '2016-06-29 19:28:13', 2),
(5, '0005', 'Transtec', 'Transtec 35 µg/h', 3, b'1', '2016-06-29 19:28:43', 3),
(6, '0006', 'Transtec', 'Transtec 35 µg/h', 3, b'1', '2016-06-29 19:29:24', 4),
(7, '0007', 'Transtec', 'Transtec 52.5 µg/h', 3, b'1', '2016-06-29 19:29:55', 4),
(8, '0008', 'Soloro', 'Soloro7 5mg', 7, b'1', '2016-06-29 19:30:23', 5),
(9, '0009', 'Soloro', 'Soloro7 10mg', 7, b'1', '2016-06-29 19:30:46', 5),
(10, '0010', 'Transtec', 'Transtec 35 µg/h', 3, b'1', '2016-06-29 19:31:22', 6);
...
(1, '2016-07-26 00:18:52', NULL, 4, 3),
(2, '2016-07-26 14:32:36', NULL, 6, 5),
(3, '2016-07-26 15:48:44', NULL, 7, 5),
(7, '2016-07-26 18:10:11', NULL, 12, 3),
(8, '2016-07-26 18:11:03', NULL, 13, 3),
(9, '2016-07-26 19:22:05', NULL, 14, 5),
(10, '2016-07-29 14:50:07', NULL, 17, 5),
(11, '2016-07-29 14:50:08', NULL, 18, 5),
(12, '2016-07-29 14:50:09', NULL, 19, 5),
(13, '2016-07-29 14:50:10', NULL, 20, 5),
(14, '2016-07-29 23:09:53', NULL, 22, 5),
(15, '2016-07-30 22:11:44', NULL, 30, 5),
(16, '2016-08-01 01:26:13', NULL, 31, 5),
(17, '2016-08-01 01:27:15', NULL, 32, 5),
(18, '2016-08-01 01:46:11', NULL, 33, 5),
(19, '2016-08-01 12:45:27', NULL, 35, 5),
(20, '2016-08-01 13:23:09', NULL, 37, 5),
(21, '2016-08-01 13:56:03', NULL, 38, 5),
(22, '2016-08-01 14:25:38', NULL, 39, 16),
(23, '2016-08-01 15:52:36', NULL, 40, 3);
...
CREATE TABLE IF NOT EXISTS `Rss_channel` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_Rss_channel_Country` (`id_country`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
(1, 'Tutorial Medico ', 'Tutorial Medico', 'https://storage.googleapis.com/domoti/grunenthal/TutorialM%C3%A9dico_01.mp4', 'Ingles', 'c', NULL, '2016-07-12', 1, 1, 1),
(2, 'Tutorial Paciente ', 'Tutorial Paciente ', 'https://storage.googleapis.com/domoti/grunenthal/TutorialPaciente_01.mp4', 'Ingles', 'c', NULL, '2016-07-10', 1, 2, 1);
...
CREATE TABLE IF NOT EXISTS `Statistical` (
  `id_user` int(11) DEFAULT NULL,
  `id_country` int(11) NOT NULL,
  KEY `FK_Statistical_User` (`id_user`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `User` (`id`, `name`, `lastname`, `email`, `password`, `active`, `terms`, `sex`, `picture`, `changePassword`) VALUES
(1, 'admin', 'admin', 'admin@domoti-sas.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', b'1', 1, 'm', 'profile.png', 0),
(3, 'Miguel', 'Rodriguez', 'miguel.rodriguez@domoti-sas.com', '1f0160076c9f42a157f0a8f0dcc68e02ff69045b', b'1', 1, 'm', 'profile.png', 1),
(4, 'Miguel', 'Zambrano', 'miguel@domoti.rocks', '1f0160076c9f42a157f0a8f0dcc68e02ff69045b', b'1', 1, 'm', 'profile.png', 1),
(5, 'David A', 'Lopez', 'david@domoti-sas.com', '1f0160076c9f42a157f0a8f0dcc68e02ff69045b', b'1', 1, 'm', '1469858532.jpg', 0),
(6, 'Cesar', 'Gomez', 'dinl_@hotmail.com', '771d4026e7ad19fce0d7534fddb2ce53b7e0a4cd', b'1', 1, 'm', '1469858643.jpg', 0),
(7, 'Sara', 'Prieto', 'sara.prieto@domoti-sas.com', '9fb22694256f5b2e7aa7f2871f1d9bc4dbfd4249', b'1', 1, 'f', '1469548246.jpg', 0),
(8, NULL, NULL, NULL, '03c48c4459a602ed8bfa201d896186b150e22c1a', b'1', 0, '', 'profile.png', 1),
(12, 'Paola', 'Jimenez', 'paola.jimenez@domoti-sas.com', '9b9a83bd02772adbbc639a344101ab5da5ad4ac9', b'1', 0, '', 'profile.png', 1),
(13, 'Debora', 'Buendia', 'debora@domoti.rocks', '136ab8b29d10c4abc24bcb4658f286d0d83261eb', b'1', 0, '', 'profile.png', 1),
(14, 'Daniel', 'Jimenez', 'daniel.jimenez@domoti-sas.com', 'be529fe5f19f37af98abc92bdf0af539a8df093f', b'1', 1, 'f', '1469561481.jpg', 1),
(15, 'Jose', 'Fabregas', 'jose.fabregas@grunenthal.com', NULL, b'1', 0, 'm', 'profile.png', 1),
(16, 'Camila', 'Lombana', 'camila.lombana@domoti-sas.com', NULL, b'1', 0, 'f', 'profile.png', 1),
(17, 'Andy ', 'Camargo', 'andy.camargo@domoti-sas.com', '6c4b90537527e46076386011ac8a8b878ca86b87', b'1', 0, '', 'profile.png', 1),
(18, 'Andy ', 'Camargo', 'andy.camargo@domoti-sas.com', '6a1c875c46e516954d7f31c1662a97a4f82297bd', b'1', 0, '', 'profile.png', 1),
(19, 'Andy ', 'Camargo', 'andy.camargo@domoti-sas.com', '9369a4ff2d9ab3be398d74c7694a401d7c29e715', b'1', 0, '', 'profile.png', 1),
(20, 'Andy ', 'Camargo', 'andy.camargo@domoti-sas.com', '594c7d4c32cf0bf4b66bfc98b791cd5d78da8aa0', b'1', 0, '', 'profile.png', 1),
(21, 'visitador', 'medico', 'visitador@domoti-sas.com', 'c75888a58de2e3ebb101706ba71706a11ab665b8', b'1', 0, 'm', 'profile.png', 1),
(22, 'Paola', 'Jimenez', 'paola@domoti.rocks', '8060f7cc5ee005ef1066b187277996fcc7a0ff29', b'1', 0, 'm', 'profile.png', 1),
(24, 'Visitador1', 'Visitador1', 'visitador1@visitador.com', 'bd92e58a97f248a8d6ee691244f00146e751be15', b'1', 0, '', 'profile.png', 0),
(25, 'Visitador2', 'Visitador2', 'visitador2@visitadores.com', 'bd92e58a97f248a8d6ee691244f00146e751be15', b'1', 0, '', 'profile.png', 1),
(26, 'Estadista1', 'Estadista1', 'estadista1@estadistas.com', '591a7d141b19343942d91479a85eaafe5a8bed6b', b'1', 0, '', 'profile.png', 0),
(27, 'Estadista2', 'Estadista2', 'estadista2@estadistas.com', NULL, b'1', 0, '', 'profile.png', 1),
(28, 'basura', 'basura', 'basura@basuras.com', NULL, b'1', 0, '', 'profile.png', 1),
(29, 'visitador3', 'Visitador3', '2gomex@gmail.com', 'c75888a58de2e3ebb101706ba71706a11ab665b8', b'1', 0, '', 'profile.png', 0),
(30, 'Miguel', 'Zamora Mora', 'miguel.zamora@domoti-sas.com', '77edb96447a942fe4230f7bd359ea2c6ea569c1f', b'1', 1, 'm', '1470058348.png', 0),
(31, 'Juan', 'Paredes', 'juanfranciscop@gmail.co', 'b940623c1e7ebeda05b539a197a143068816d938', b'1', 0, 'm', 'profile.png', 1),
(32, 'Juan', 'Paredes', 'juanfranciscop@gmail.com', '9fb22694256f5b2e7aa7f2871f1d9bc4dbfd4249', b'1', 1, 'm', 'profile.png', 0),
(33, 'Cami ', 'Lombi', 'kmi444@gmail.com', 'af3317e78fb857531e2de0c3aac20eb4f6a29347', b'1', 1, '', 'profile.png', 0),
(34, 'estadista1', 'estadista', 'estadista1@estadistas.com', '591a7d141b19343942d91479a85eaafe5a8bed6b', b'1', 0, '', 'profile.png', 1),
(35, 'cristian', 'Cruz', 'Cristian.cruz@domoti-sas.com', '01930a5d3c096f10924d33bbb792117aed8b7a24', b'1', 0, '', 'profile.png', 1),
(36, 'Camila', 'visitadora', 'kmi444@gmail.com', '9fb22694256f5b2e7aa7f2871f1d9bc4dbfd4249', b'1', 0, '', 'profile.png', 0),
(37, 'Camila', 'Lombana', 'kmi444@gmail.com', 'fb6fac162ec342780692ed4aabb75c8b4305c582', b'1', 0, 'm', 'profile.png', 1),
(38, 'jairo', 'Medina', 'Jaalmeri@gmail.com', '6d8a2db8f393195844cb5f8c2b54a07f62ac23c4', b'1', 0, '', 'profile.png', 1),
(39, NULL, NULL, 'prueba@prueba.com', '0af1088937f7f0514293b348cde19e560c88a488', b'1', 0, 'f', 'profile.png', 1),
(40, 'Camila', 'Sanchez', 'Camila.sanchez@domoti-sas.com', 'a88d301dab8935e93608f67b29ccea34555e4433', b'1', 0, '', 'profile.png', 1);
...
ALTER TABLE `Application`
  ADD CONSTRAINT `FK_Application_Dose` FOREIGN KEY (`id_dose`) REFERENCES `Dose` (`id`),
  ADD CONSTRAINT `FK_Application_Recipe_Product_Dose` FOREIGN KEY (`id_dose`) REFERENCES `Dose` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Doctor`
--
ALTER TABLE `Doctor`
  ADD CONSTRAINT `FK_Doctor_Country` FOREIGN KEY (`id_country`) REFERENCES `Country` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Doctor_Specialization` FOREIGN KEY (`id_specialization`) REFERENCES `Specialization` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Doctor_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Dose`
--
ALTER TABLE `Dose`
  ADD CONSTRAINT `FK_Recipe_Product_Dose_Product` FOREIGN KEY (`id_product`) REFERENCES `Product` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Recipe_Product_Dose_Recipe` FOREIGN KEY (`id_recipe`) REFERENCES `Recipe` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Group_user`
--
ALTER TABLE `Group_user`
  ADD CONSTRAINT `FK_Group_user_Group` FOREIGN KEY (`id_group`) REFERENCES `Group` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Group_user_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Line`
  ADD CONSTRAINT `FK_Line_Country` FOREIGN KEY (`id_country`) REFERENCES `Country` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Notification`
--
ALTER TABLE `Notification`
  ADD CONSTRAINT `FK_Notification_Recipe_Product_Dose` FOREIGN KEY (`id_dose`) REFERENCES `Dose` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Notification_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `Pain_report`
  ADD CONSTRAINT `FK_Pain_report_User` FOREIGN KEY (`id_patient`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `Patient`
  ...
  ADD CONSTRAINT `FK_Patient_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `Product`
  ADD CONSTRAINT `FK_Product_Line` FOREIGN KEY (`id_line`) REFERENCES `Line` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Recipe`
--
ALTER TABLE `Recipe`
  ADD CONSTRAINT `FK_Recipe_User` FOREIGN KEY (`id_patient`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Recipe_User_02` FOREIGN KEY (`id_doctor`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Filtros para la tabla `Statistical`
--
ALTER TABLE `Statistical`
  ADD CONSTRAINT `FK_Statistical_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `Visitor`
--
ALTER TABLE `Visitor`
  ADD CONSTRAINT `FK_Visitor_User` FOREIGN KEY (`id_user`) REFERENCES `User` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
